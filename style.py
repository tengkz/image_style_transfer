...
# content loss
losses.append(loss_alpha1 * content_loss(photo_features, gen_features, 'conv4_2'))

# style loss
losses.append(loss_alpha2 * style_loss(art_features, gen_features, 'conv1_1'))
losses.append(loss_alpha2 * style_loss(art_features, gen_features, 'conv2_1'))
losses.append(loss_alpha2 * style_loss(art_features, gen_features, 'conv3_1'))
losses.append(loss_alpha2 * style_loss(art_features, gen_features, 'conv4_1'))
losses.append(loss_alpha2 * style_loss(art_features, gen_features, 'conv5_1'))

# total variation penalty
losses.append(loss_alpha3 * total_variation_loss(generated_image))
